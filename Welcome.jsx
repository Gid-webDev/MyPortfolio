...
const Welcome = () => {
    ...
    const ProfilePix = {
      borderRadius:'50% 20px', width:'100%', boxShadow:'7px 8px rgb(255, 255, 255, 0.25)',
      position:'relative',
  }
  ...
  const NameContainer = {
    color:'#ddd', textAlign:'start', padding:'0 20px', position:'relative',
    zIndex:'10'
  }
  const Names = {
...
const Btn = {
  width:'180px', padding:'10px 14px', fontSize:'16px', color:'#111', position:'relative',
